...
![68249204474](Day06-Main-assets/1682492044744.png)
...
语法： ```html<router-link to="path的值">发现音乐</router-link>```
...
当我们使用```html<router-link></router-link>```跳转时，自动给当前导航加了**两个类名**

![68249312105](Day06-Main-assets/1682493121052.png)
...
![68249361091](Day06-Main-assets/1682493610911.png)
...
![68249372945](Day06-Main-assets/1682493729456.png)
...
![68249442392](Day06-Main-assets/1682494423923.png)
...
- 如何传参？
  ...
  ```html<router-link to="/path?参数名=值"></router-link>```
...
.logo-box {
  height: 150px;
  background: url('@/Day06-Main-assets/logo.jpeg') no-repeat center;
}
.search-box {
  display: flex;
...
![68249723830](Day06-Main-assets/1682497238305.png)
...
![68249787282](Day06-Main-assets/1682497872821.png)
...
![68250048105](Day06-Main-assets/1682500481059.png)
...
![68250272058](Day06-Main-assets/1682502720585.png)
...
![68255978464](Day06-Main-assets/1682559784643.png)
...
![68256025535](Day06-Main-assets/1682560255356.png)
...
2.配置二级路由的出口 ```html<router-view></router-view>```
...
- 将a标签替换成 ```html<router-link></router-link>```组件，配置to属性，不用加 #
...
![68257863006](Day06-Main-assets/1682578630060.png)
